...
- LM-B02: 완전한 파일 coverage를 검증한 prefix별 완료 위치 색인을 추가했다. 없음·손상·누락/외부 변경은 전체 CSV 검색·재구축이며 CSV 적중의 flush→재대조→fsync는 유지한다. index11 PASS, cold rebuild와 실제 운영 성능의 한계는 [운영](operations.md#responsiveness-w2)을 따른다.
