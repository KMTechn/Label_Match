...
| relay 독립 소스 종결·후속 FULL 준비 | [검토·commit·successor 입력 정본](E:/KMTech/coordinator-handoff-20260907-01a07992/repo-parallel-0826/label-relay-closure-review/REVIEW-PREPARE.md), frozen product/test와 45개 writer identity·guard 종류 독립 대조 | 기존 Stage/MainStage는 394c21f의 역사 근거. 새 Stage/MainStage/Setup 및 FULL은 Main의 packet 수용·VM01 배정 뒤 별도 실행하며 Ready 0/6 유지 |
