...
def test_package_review_api_consumer_set_requires_review():
    ...
    expected = {
        ...
        'tests/_business_flow_fixture.py:BusinessCase.open': '_start_package_outbox_drain',
        ...
        'tests/test_label_operator_workbench.py:test_restored_exchange_guidance_matches_blocked_actions': 'ExchangeReviewSnapshot,PackageReviewSnapshot,_package_review_context,_package_review_snapshot',
        'tests/test_label_operator_workbench.py:test_exchange_guidance_preserves_existing_blocking_notice': 'ExchangeReviewSnapshot,PackageReviewSnapshot,_package_review_context,_package_review_snapshot',
        'tests/test_label_operator_workbench.py:test_exchange_guidance_clears_when_existing_attempt_no_longer_blocks': 'ExchangeReviewSnapshot,PackageReviewSnapshot,_package_review_context,_package_review_snapshot',
