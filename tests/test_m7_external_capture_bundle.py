...
def test_canonical_validator_uses_reviewed_repository_copy():
    expected = Path(__file__).resolve().parents[1] / "tools/validate_capture_bundle_v1.py"
    assert publisher.M7_CANONICAL_VALIDATOR == expected
