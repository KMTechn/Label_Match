...
class RasterImage:
    ...
    def resized(self, width: int, height: int, *, resample: Resample = "bilinear") -> "RasterImage":
        ...
        return type(self)(width, height, bytes(output))
...
class RasterCanvas:
    ...
    # App facades override this class to retain their guarded save_png.
    image_class: type[RasterImage] = RasterImage
    ...
    def snapshot(self) -> RasterImage:
        ...
        return self.image_class(self.width, self.height, bytes(raw))
